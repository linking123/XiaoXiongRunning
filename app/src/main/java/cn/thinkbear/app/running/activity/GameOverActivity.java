...
public class GameOverActivity extends Activity {
    ...
    private void doInitView() {
        this.over = super.findViewById(R.id.over);
        this.score1 = super.findViewById(R.id.score1);
        this.score2 = super.findViewById(R.id.score2);
        this.replay = super.findViewById(R.id.replay);
        this.backMenu = super.findViewById(R.id.backMenu);
